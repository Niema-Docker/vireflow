...
RUN apt-get update && apt-get -y upgrade && \
    DEBIAN_FRONTEND=noninteractive TZ=Etc/UTC apt-get install -y autoconf g++ libbz2-dev libcurl4-openssl-dev liblzma-dev make python3 unzip wget zip zlib1g-dev && \
